#ifndef USBREGS_H_INCLUDED
#define USBREGS_H_INCLUDED
...
#define ISTR_POVR   (0x4000) /* PMA OVeR/underrun (clear-only bit) */
...
#define CLR_POVR   (~ISTR_POVR)  /* clear PMA OVeR/underrun bit*/
